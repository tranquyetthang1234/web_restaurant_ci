		...
		<div class="col-xs-12">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<form action="<?php echo base_url()?>Backend/BookTableController/edit/<?php echo $item->id?>" method="POST" role="form">
						...
						<button type="submit" class="btn btn-primary">Cập nhật</button>
								<a href="<?php echo base_url()?>Backend/BookTableController/"><span class="btn btn-info">Quay lại</span></a>
					</form>
