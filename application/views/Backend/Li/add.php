		...
		<div class="col-xs-12">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<form action="<?php echo base_url()?>Backend/LiController/add" method="POST" role="form" enctype="multipart/form-data">
						...
						<button type="submit" class="btn btn-primary">Thêm</button>
								<a href="<?php echo base_url()?>Backend/LiController/"><span class="btn btn-info">Quay lại</span></a>
					</form>
