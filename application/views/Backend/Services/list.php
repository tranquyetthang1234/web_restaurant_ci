             ...
             <?php $i= 1;foreach ($list as $key => $value) { ?>   
              <tr class="gradeX">
                  ...
                  <td class=""><a href="<?php echo base_url()?>index.php/Backend/ServiceController/edit/<?php echo $value->id ?>"><i class="glyphicon glyphicon-pencil "></i> Sửa</a></td>
                   <td class=""> <a onclick="return confirm('Bạn có chắc chắn xóa ?')" href="<?php echo base_url()?>index.php/Backend/ServiceController/del/<?php echo $value->id ?>"><i class="glyphicon glyphicon-trash "></i> Xóa</a></td>
              </tr>
              <?php }?>
