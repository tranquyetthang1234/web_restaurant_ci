             ...
             <span class="tools pull-right">
              ...
              <div class="panel-body">
               <form action="<?php echo base_url()?>index.php/Backend/TypeEatController/check" method="POST">
               <div class="btn btn-shadow btn-success "><a href="<?php
                echo base_url();?>index.php/Backend/TypeEatController/add"><i class="glyphicon glyphicon-plus"></i>Thêm mới</a></div>
             ...
             <?php if($this->session->flashdata('message')):?>
              ...
              <tr>
                  ...
                  <th class="hidden-phone" >Sắp Xếp</th>
                  <th>Trạng thái</th>
             ...
             <?php $i= 1;foreach ($list as $key => $value) { ?>   
              <tr class="gradeX">
                  ...
                  <td class=""><a href="<?php echo base_url()?>index.php/Backend/TypeEatController/edit/<?php echo $value->id ?>"><i class="glyphicon glyphicon-pencil "></i> Sửa</a></td>
                   <td class=""> <a onclick="return confirm('Bạn có chắc chắn xóa ?')" href="<?php echo base_url()?>index.php/Backend/TypeEatController/del/<?php echo $value->id ?>"><i class="glyphicon glyphicon-trash "></i> Xóa</a></td>
              </tr>
              <?php }?>
